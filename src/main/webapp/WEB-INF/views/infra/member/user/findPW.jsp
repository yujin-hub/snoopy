...
<body>
	...
	<div class="container" id="wid2">
		<h1 style="display: inline;">비밀번호 찾기</h1> 
		<span id="font">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;비밀번호가 기억나지 않으세요? 원하시는 방법을 선택해 비밀번호를 확인하실 수 있습니다.</span>
		<hr id="hr2">
		<span id="right">&nbsp; 비밀번호 찾기</span>
		<span id="right">&nbsp; ></span>
		...
		<div class="container" id="wid4">
			<div class="row">
				<div class="col-6">
					<h2>임시 비밀번호 발급</h2>
					<br>
					<span id="gray">입력하신 정보는 임시 비밀번호 발급에만 사용되며</span><br>
					<span id="red">저장되지 않습니다.</span>
					<div class="container" id="wid5">
						<br>
 						<input type="text" class="form-control" placeholder="아이디를 입력해주세요." aria-label="Username" aria-describedby="basic-addon1">
 						<br>
						...
						<br>
						<a href="../member/pwSetDone">
							<button type="button" class="btn btn2">비밀번호 찾기</button>
						</a>
					</div>
				</div>
				<div class="col-6">
					...
					<input type="text" class="form-control control2" placeholder="아이디를 입력해주세요." aria-label="id" aria-describedby="basic-addon1">
					<div class="container" id="wid5">
						<br>
						<br>
						<div class="row gx-5">
