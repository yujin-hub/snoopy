					...
					<div class="col-9 font">
						...
						<div class="row">
							...
							<div class="col-9">
								...
								<input type="text" class="form-control" aria-label="addr" aria-describedby="basic-addon1" value="서울특별시 서초구 서초대로77길 55">
								<input type="text" class="form-control" aria-label="addr" aria-describedby="basic-addon1" value="에이프로스퀘어 3층">
							</div>
						</div>
						<br>
						<div class="row">
							...
							<div class="col-9">
								<div class="input-group mb-3">
									<input type="text" class="form-control" value="cuj0405" aria-label="Username">
									<span class="input-group-text">@</span>
									<input type="text" class="form-control" value="naver.com" aria-label="Server">
								</div>
							</div>
						</div>
						<br>
						...
						<div class="row">
							...
							<div class="col-9">
								<button type="button" class="btn btn3 btn-space">지성</button>
						...
						<hr class="hr1">
						<br>
						<a href="/member/mypageProfile">
							<span style="float: right; font-size: 15px;" class="cursor done"><i class="fa-solid fa-check-double"> 수정 완료</i></span>
						</a>
					</div>
				</div>
			</div>
