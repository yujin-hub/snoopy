...
<html lang="ko">
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=e2405cb6e30cd78e7478b78325118dec"></script>
		...
		<div class="row">
			...
			<div class="col-9" style="margin-top: 8px;">
				...
				<div class="row gy-2">
					...
					<div class="col-6">
						<input type="text" id="Lat" class="form-control" placeholder="위도" disabled>
					</div>
					<div class="col-6">
						<input type="text" id="Lng" class="form-control" placeholder="경도" disabled>
					</div>
				</div>
				<hr>
				<span>직장 주소</span>
