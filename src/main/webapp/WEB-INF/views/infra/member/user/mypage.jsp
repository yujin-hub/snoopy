		...
		<div class="row">
			<div class="col-2 text">
				...
				<ul class="nav flex-column">
					<li class="nav-item">
						<a class="nav-link ab" href="mypageOrder.html">주문/배송 조회</a>
					</li>
					<li class="nav-item">
						<a class="nav-link ab" href="mypageSecession.html">회원 탈퇴</a>
					</li>
				</ul>
			</div>
			<br>
			...
			<div class="col-10 bg">
				<div class="row">
					...
					<div class="col-2 profile">
						<span class="cursor" onClick="profile()">나의 프로필 &nbsp;&nbsp;&nbsp; ></span>
					</div>
					<div class="row left">
						<div class="col-4">
							<div class="font">
...
<script type="text/javascript">
	 ...
	 function profile()
		{
		     location.href = "mypageProfile.html";
		}
