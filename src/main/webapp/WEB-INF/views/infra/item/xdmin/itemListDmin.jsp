	...
	<div id="Header">
		<div class="top_util">
			<ul class="menu_list" id="menu_list_header">
				...
				<li class="cart"><a href="../member/memberList"data-attr='공통^헤더^장바구니'>관리 홈<span id="cartToCnt"></span></a></li>
			</ul>
		</div>
		
		<form autocomplete="off">
			<div class="header_inner" >
	            <h1><a href="itemListDmin"><img src="https://image.oliveyoung.co.kr/pc-static-root/image/comm/h1_logo.png" alt="올리브영"></a></h1>
	...
	<div class= "container" id="wid"> 
		...
		<div class="row">
			<div class="col-md-3" id="left">
				...
				<a href = "../reviewQnASet/modSet.html"><div class="card" style="width: 16rem;" id="item">
				  <a href = "../reviewQnASet/modSet.html"><img src="https://image.oliveyoung.co.kr/uploads/images/goods/550/10/0000/0015/A00000015771628ko.jpg?l=ko" class="card-img-top" alt="..."></a>
				  <br>
